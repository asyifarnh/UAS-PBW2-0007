...
<div class="container">
    <div class="row">
        <div class="col">
            <div class="info">
                <center>
                    <h2><i class="fas fa-th-list"></i>&nbsp;&nbsp;Kelola Data Inagurasi Mahasiswa 2021</h2>
                </center>
                        ...
                        <form action="<?= base_url('admin/update/'.$dt['id']); ?>" method="POST">
                            ...
                            <div class="modal-body bg-dark">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="box-registry">
                                        <i class="fas fa-building"></i>
                                        <input type="text" placeholder="Nim" name="nim" value="<?= $dt['nim']; ?>" required>
                                    </div>

                                    <div class="box-registry">
                                        <i class="fab fa-whatsapp"></i>
                                        <input type="text" placeholder="Komentar" name="komentar" value="<?= $dt['komentar']; ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
