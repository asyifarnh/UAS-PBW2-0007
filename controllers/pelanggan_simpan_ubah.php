...
$query = 'UPDATE ms_pelanggan SET nama_pelanggan="' . $nama_pelanggan . '", alamat_pelanggan="' . $alamat_pelanggan . '", telp_pelanggan="' . $telp_pelanggan . '", aktif_pelanggan="'.$aktif_pelanggan.'" WHERE kode_pelanggan="' . $kode_pelanggan . '"';
